...
(n = this),
  (t = function () {
    ...
    function at(u, i, r, o) {
      ...
      function k(n) {
        n !== B(o, qn) &&
          (E(o, qn, n), v && j(o, tt, n || null), c(n ? gn : mn, L));
      }
      function A() {
        var n = u.index;
      ...
      var L = {
        ...
        isWithin: function (n, t) {
          return (
            (n = un(n - i)),
            (n = !m && (d.rewind || u.is(ct)) ? $(n, u.length - n) : n) <= t
          );
        },
      };
      return L;
    ...
    var _t = Object.freeze({
        ...
        Layout: function (n, t, i) {
            ...
            (u && u.width === n.width && u.height === n.height) ||
              (C(
                ...
                (function () {
                  var n = "";
                  r &&
                    (Q((n = y()), "height or heightRatio is missing."),
                    (n = "calc(" + n + " - " + m(!1) + " - " + m(!0) + ")"));
                  return n;
                })()
              ),
              ...
              a.style(
                "width",
                (i.autoWidth ? "" : V(i.fixedWidth) || (r ? "" : w())) || null
              ),
              a.style(
                "height",
                V(i.fixedHeight) ||
          ...
          return {
            mount: function () {
              p(),
                c(window, "resize load", Dn(f.bind(this, kn))),
                e([xn, bn], p),
                e(kn, g);
            },
            listSize: function () {
            ...
            getPadding: function (n) {
              return (
                parseFloat(C(d, s("padding" + (n ? "Right" : "Left")))) || 0
              );
            },
          };
        },
        ...
        Move: function (e, c, f) {
          ...
          function y(n, t) {
            e.is(ft) ||
              ...
              (h.style.transform = "translate" + d("X") + "(" + t + "px)"),
              n !== t && s(hn));
          }
          function w(n, t) {
            var i = n - x(t),
            ...
            move: function (n, t, i, r) {
              ...
              k() ||
                ...
                a.start(t, function () {
                  u(3),
                    s(vn, t, i, n),
                    "move" === f.trimSpace && n !== i && o === b()
                      ? c.Controller.go(i < n ? ">" : "<", !1, r)
                      : r && r();
                }));
            },
            jump: m,
        ...
        Controller: function (n, e, u) {
          ...
          function E(n) {
            return (
              P() || ((n = on(n, o - f, o - 1) ? o - 1 : n), (n = tn(n / f))), n
            );
          }
          function S(n) {
            n = a.toIndex(n);
          ...
          function g() {
            ...
            i.arrows &&
              ((v && h) ||
                ...
                (r = !0),
                L(d, [v, h]),
                S(d, P(("slider" === i.arrows && s.slider) || u.root)))),
              v &&
                h &&
                (p.prev
                  ? N(d, !1 === i.arrows ? "none" : "")
        ...
        Autoplay: function (t, i, r) {
          ...
          function h() {
            l() &&
              i.Slides.isEnough() &&
              (s.start(!r.resetProgress), (o = u = e = !1), a("autoplay:play"));
          }
          function p(n) {
            void 0 === n && (n = !0),
        ...
        Scroll: function (c, n, f) {
                ...
                function (n) {
                  ...
                  d.translate(t + i),
                    c.is(et) &&
                      ...
                      p() &&
                      ((e *= 0.6),
                      un(i) < 10 && ((i = p(!1)), g(h(!i), 600, null, !0)));
                },
                1
              )),
              l("scroll"),
          ...
          function m() {
            var n = v(),
              t = d.toIndex(n);
            on(t, 0, c.length - 1) || d.translate(d.shift(n, 0 < t), !0),
              s && s(),
              l(En);
          }
          function y() {
            ...
            s
              ? ((d || (n.cancelable && O())) &&
                  ...
                  (i =
                    ...
                    cn(i) *
                      $(
                        un(i) * (e.flickPower || 600),
                        l ? 1 / 0 : o.Layout.listSize() * (e.flickMaxPages || 1)
                      )),
                  l
                    ? _.scroll(i)
                    : u.is(ft)
        ...
        Keyboard: function (t, n, i) {
          ...
          function l() {
            var n = i.keyboard;
            n &&
              ("focused" === n ? j((r = a), ut, 0) : (r = window), c(r, pt, p));
          }
          function d() {
            f(r, pt), y(r) && T(r, ut);
          }
          ...
          function p(n) {
            u ||
              ((n = n.key),
              (n = x(ht, n) ? "Arrow" + n : n) === s("ArrowLeft")
                ? t.go("<")
                : n === s("ArrowRight") && t.go(">"));
          }
          return {
            ...
            n.Slides.forEach(function (o) {
              J(o.slide, yt).forEach(function (n) {
                ...
                (r === n.src && u === n.srcset) ||
                  ((t = e.classes.spinner),
                  j(
                    (i = P((i = n.parentElement), "." + t) || F("span", t, i)),
                    $n,
                    "presentation"
                  ),
                  a.push({
        ...
        Pagination: function (l, n, d) {
          ...
          function w(t) {
            o.go(">" + t, !0, function () {
              ...
              n &&
                (((n = n.slide).setActive && n.setActive()) ||
                  n.focus({
                    preventScroll: !0,
                  }));
            });
    ...
    i = (function () {
      ...
      return (
        ...
        (r.emit = function (n) {
          var t;
          return (
            (t = this.event).emit.apply(t, [n].concat(s(arguments, 1))), this
          );
        }),
        (r.add = function (n, t) {
